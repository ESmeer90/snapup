...
const EVENT_TYPE_LABELS: Record<string, { label: string; color: string; bg: string; icon: React.ReactNode }> = {
  ...
  order_receipt_buyer: { label: 'Buyer Receipt', color: 'text-emerald-700', bg: 'bg-emerald-100', icon: <Mail className="w-3 h-3" /> },
  order_receipt_seller: { label: 'Seller Receipt', color: 'text-blue-700', bg: 'bg-blue-100', icon: <Send className="w-3 h-3" /> },

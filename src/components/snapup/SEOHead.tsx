...
// OG image hosted on CDN — 1200x630 branded social preview (blue gradient, S logo, trust badges)
...
const SEOHead: React.FC<SEOHeadProps> = ({
  ...
  useEffect(() => {
    ...
    setMetaTag('og:image:secure_url', ogImg, true);
    setMetaTag('og:image:type', 'image/jpeg', true);
    setMetaTag('og:image:width', '1200', true);
    setMetaTag('og:image:height', '630', true);
    setMetaTag('og:image:alt', ogTitle || fullTitle, true);

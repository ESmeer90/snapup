...
import {
  ...
  AlertTriangle, RefreshCw, MapPin, Calendar, Banknote, Banknote as DollarSign, User,
        ...
        <div className="border-t border-gray-100 p-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-gray-50 rounded-lg p-3">
              ...
              <p className="text-sm font-medium text-gray-900">{order.payment_method || 'Online Payment'}</p>
            </div>
            <div className="bg-gray-50 rounded-lg p-3">
              <p className="text-xs text-gray-500">Payment Reference</p>
              <p className="text-sm font-mono font-medium text-gray-900">{order.payment_id || 'N/A'}</p>

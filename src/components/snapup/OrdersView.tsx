  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="mt-8 bg-blue-50 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          <p className="text-sm font-semibold text-blue-800">Secure Transactions with Delivery Tracking</p>
          <p className="text-xs text-blue-600 mt-1">
            All transactions are protected by SnapUp Buyer Protection. Sellers can update delivery tracking in real-time.
